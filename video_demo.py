...
def parse_args():
    ...
    parser.add_argument('--video', default='E:/Faces/video/faces.avi', type=str, help='Input video file path')
    parser.add_argument('--output', default='E:/Faces/video/output_faces.avi', type=str, help='Output video file path')
